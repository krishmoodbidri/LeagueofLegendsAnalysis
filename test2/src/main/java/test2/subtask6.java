...
public class subtask6
{
    public static void main( String[] args ) throws Exception
    {
    	...
    	Job job = Job.getInstance(conf, "Damage done per champion");
	    job.setJarByClass(subtask6.class);
	    job.setMapperClass(st6Mapper.class);
	    job.setCombinerClass(st6Reducer.class);
	    job.setReducerClass(st6Reducer.class);
    ...
    static class st6Mapper extends Mapper<Object, Text, Text, IntWritable> {
	...
	static class st6Reducer extends Reducer<Text, IntWritable, Text, IntWritable> {
