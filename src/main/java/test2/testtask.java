...
public class testtask
{
    public static void main( String[] args ) throws Exception
    {
	    ...
	    job.setJarByClass(testtask.class);
	    job.setMapperClass(st1Mapper.class);
	    job.setCombinerClass(st1Reducer.class);
	    job.setReducerClass(st1Reducer.class);
    ...
    static class st1Mapper extends Mapper<Object, Text, Text, IntWritable> {
		...
		public void map(Object key, Text value, Context context) throws IOException, InterruptedException {
			...
			for (int i = 0; i < players.length(); i++) {
				...
				write.set(Integer.toString(teamID));
	...
	static class st1Reducer extends Reducer<Text, IntWritable, Text, IntWritable> {
